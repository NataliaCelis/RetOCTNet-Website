...
def main():
    ...
    parser.add_argument('--discard', type=str2bool, default=False, required=False, help='Discard the first six patches (Built for mouse data analysis).')
    ...
    if args.num_images: 
        ...
        if args.mouse:
            # Fixed the bug: was list_of_files1, now list_of_files  
            list_of_files = [file for file in list_of_files if file.endswith('Scan_2.tiff')]
